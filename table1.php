    ...
    <div class="main-content">
        ...
        <div class="section">
            ...
            <table>
                ...
                require 'config.php';
                $sql = "SELECT 	userId,name,nic,dob,gender,phoneNo,address,email,planeType,usertype from userdetail Where usertype ='ADMIN'";
            ...
            <table>
                ...
                require 'config.php';
                $sql = "SELECT 	userId,name,nic,dob,gender,phoneNo,address,email,planeType,usertype from userdetail Where usertype ='CLIENT'";
