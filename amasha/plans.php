...
<?php  include ('../hasaranga/hedder.php') ;  ?>
    ...
    <section class="plans">
        ...
        <a href = "../lahindu/emargency.php" style =  "text-decoration: none;">
          <div class="plan">
            ...
            <a href = "../hasaranga/CompletePlan.php" style =  "text-decoration: none;"> <div class="plan">
            ...
            <a href = "../lahindu/Famillyinone.php" style =  "text-decoration: none;">
            <div class="plan">
            ...
            <a href = "../hasaranga/ElderPlan.php" style =  "text-decoration: none;"><div class="plan">
    ...
    <section class="opportunities">
        ...
        <a href = "../lahindu/oppunite.php"><button class="cta-btn">Get Started</button></a>
    </section>
